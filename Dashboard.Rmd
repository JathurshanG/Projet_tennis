...
```
<h3> `r Nom` `r Prenom` </h3>

<right> Date de Naissance : `r DTN ` </right>

<right> Pays d'origine = `r Nationalite` </right>

<right> Main Favorite = `r Main ` </right>
...
### Points marquées par `r Lastname` durant sa carrière professionnelle.
